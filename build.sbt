lazy val commonSettings = Seq(
  ...
  crossScalaVersions := Seq(scalaVersion.value, "2.12.21", "3.3.8"),
  scalacOptions ++= Seq(
    "-encoding",
    "UTF-8",
    "-unchecked",
...
// Apache 2.0 in October 2025 (after the 3-year BSL conversion period).
// Akka 2.8.0 and Akka HTTP 10.5.0 were released in Feb-Mar 2023 under BSL and converted to
// Apache 2.0 in Feb-Mar 2026 (after the 3-year BSL conversion period). Newer versions remain
